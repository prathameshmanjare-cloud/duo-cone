...
import slideWelcome from "../../assets/industries/seal-df-do.png";
...
const SLIDES: Slide[] = [
  {
    ...
    copy: "German-engineered mechanical face seals (DF and DO type) for the heaviest duty on earth. Stocked in Engelskirchen, shipped within 24 hours.",
