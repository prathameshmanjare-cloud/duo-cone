...
export const LegalNotice = () => (
  <StaticPage
    ...
    sections={[
      {
        heading: "Provider",
        body: "Kumar Chugh, Benzstraße 21, 51381 Leverkusen, Germany. Tel.: +49 155 10386300. E-mail: duo-cone@outlook.com.",
      },
      {
    ...
    sections={[
      {
        ...
        body: "We are pleased that you are visiting our website and thank you for your interest. On the following pages, we inform you about the handling of your personal data when using our website. Personal data is all data with which you can be personally identified. The controller in charge of data processing on this website, within the meaning of the General Data Protection Regulation (GDPR), is Kumar Chugh, Benzstraße 21, 51381 Leverkusen, Phone: +49 155 10386300, e-mail: duo-cone@outlook.com. The controller in charge of the processing of personal data is the natural or legal person who alone or jointly with others determines the purposes and means of the processing of personal data.",
      },
      {
